  ...
  return (
    <div className="flex flex-col items-center gap-16">
      <button
        type="button"
        onClick={open}
        aria-label="Start a voice conversation with the AI Architect"
      ...
      >
        ...
        <div className="z-10 text-center">
          <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-gray-800 to-black border border-white/10 shadow-2xl flex items-center justify-center group-hover:border-cyan-400/40 transition-colors">
            <Icon name="wave-square" className="text-4xl text-cyan-400" />
          </div>
          <h2 className="text-lg font-semibold mb-2">
            What Are You Trying To Build?
          </h2>
          <p className="text-xs text-gray-500">Speak or type your idea</p>
        </div>
      ...
      >
        <span className="relative w-10 h-10 flex items-center justify-center">
          ...
          <Icon name="microphone" className="text-primary" />
        </span>
